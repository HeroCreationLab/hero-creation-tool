...
import { getEquipmentEntries } from '../indexes/getEntries';
import { EquipmentEntry } from '../indexes/entries/equipmentEntry';
      ...
      case PackNames.BURGLAR:
        ...
        this.addItemOptionToSelection(
          ...
          new OptionContainer(
            ...
            options,
            PackNames.BURGLAR,
            `${PackPrices.BURGLAR.value}${PackPrices.BURGLAR.denomination}`,
      ...
      case PackNames.DIPLOMAT:
        ...
        this.addItemOptionToSelection(
          ...
          new OptionContainer(
            ...
            options,
            PackNames.DIPLOMAT,
            `${PackPrices.DIPLOMAT.value}${PackPrices.DIPLOMAT.denomination}`,
            { addValues: true, deletable: true },
            (opt: DeletableOption) => this.onDelete(opt),
            id,
          ),
      ...
      case PackNames.DUNGEONEER:
        ...
        this.addItemOptionToSelection(
          ...
          new OptionContainer(
            ...
            `${PackPrices.DUNGEONEER.value}${PackPrices.DUNGEONEER.denomination}`,
            { addValues: true, deletable: true },
            (opt: DeletableOption) => this.onDelete(opt),
            id,
          ),
      ...
      case PackNames.ENTERTAINER:
        ...
        this.addItemOptionToSelection(
          ...
          new OptionContainer(
            ...
            `${PackPrices.ENTERTAINER.value}${PackPrices.ENTERTAINER.denomination}`,
            { addValues: true, deletable: true },
            (opt: DeletableOption) => this.onDelete(opt),
            id,
          ),
      ...
      case PackNames.EXPLORER:
        ...
        this.addItemOptionToSelection(
          ...
          new OptionContainer(
            ...
            options,
            PackNames.EXPLORER,
            `${PackPrices.EXPLORER.value}${PackPrices.EXPLORER.denomination}`,
            { addValues: true, deletable: true },
            (opt: DeletableOption) => this.onDelete(opt),
            id,
          ),
      ...
      case PackNames.PRIEST:
        ...
        this.addItemOptionToSelection(
          ...
          new OptionContainer(
            ...
            options,
            PackNames.PRIEST,
            `${PackPrices.PRIEST.value}${PackPrices.PRIEST.denomination}`,
            { addValues: true, deletable: true },
            (opt: DeletableOption) => this.onDelete(opt),
            id,
          ),
      ...
      case PackNames.SCHOLAR:
        ...
        this.addItemOptionToSelection(
          ...
          new OptionContainer(
            ...
            options,
            PackNames.SCHOLAR,
            `${PackPrices.SCHOLAR.value}${PackPrices.SCHOLAR.denomination}`,
            { addValues: true, deletable: true },
            (opt: DeletableOption) => this.onDelete(opt),
            id,
          ),
